...
async function getFilteredData() {
    ...
    try {
        ...
        const filteredData = await getCollectionData("/homework/Non-fiction and Speaking/items", [
            dateRangeFilter,
            todayFilter,
            ...
            if (item.status === "check") {
                ...
                button.addEventListener("click", async () => {
                    ...
                    try {
                        ...
                        await updateDocumentData(`homework/Non-fiction and Speaking/items/${item.id}`, { status: "done" });
